...
# Unit tests for ESI::CorporationsCorporationIdAssetsGetInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ESI::CorporationsCorporationIdAssetsGetInner do
  #let(:instance) { ESI::CorporationsCorporationIdAssetsGetInner.new }

  describe 'test an instance of CorporationsCorporationIdAssetsGetInner' do
    it 'should create an instance of CorporationsCorporationIdAssetsGetInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ESI::CorporationsCorporationIdAssetsGetInner)
    end
  end
