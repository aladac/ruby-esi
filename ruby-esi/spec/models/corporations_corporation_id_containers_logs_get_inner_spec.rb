...
# Unit tests for ESI::CorporationsCorporationIdContainersLogsGetInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ESI::CorporationsCorporationIdContainersLogsGetInner do
  #let(:instance) { ESI::CorporationsCorporationIdContainersLogsGetInner.new }

  describe 'test an instance of CorporationsCorporationIdContainersLogsGetInner' do
    it 'should create an instance of CorporationsCorporationIdContainersLogsGetInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ESI::CorporationsCorporationIdContainersLogsGetInner)
    end
  end
