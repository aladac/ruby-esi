...
# Unit tests for ESI::CharactersCharacterIdAssetsGetInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ESI::CharactersCharacterIdAssetsGetInner do
  #let(:instance) { ESI::CharactersCharacterIdAssetsGetInner.new }

  describe 'test an instance of CharactersCharacterIdAssetsGetInner' do
    it 'should create an instance of CharactersCharacterIdAssetsGetInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ESI::CharactersCharacterIdAssetsGetInner)
    end
  end
