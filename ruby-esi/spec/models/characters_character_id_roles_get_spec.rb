...
# Unit tests for ESI::CharactersCharacterIdRolesGet
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ESI::CharactersCharacterIdRolesGet do
  #let(:instance) { ESI::CharactersCharacterIdRolesGet.new }

  describe 'test an instance of CharactersCharacterIdRolesGet' do
    it 'should create an instance of CharactersCharacterIdRolesGet' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ESI::CharactersCharacterIdRolesGet)
    end
  end
