...
# Unit tests for ESI::CharactersCharacterIdOrdersHistoryGetInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ESI::CharactersCharacterIdOrdersHistoryGetInner do
  #let(:instance) { ESI::CharactersCharacterIdOrdersHistoryGetInner.new }

  describe 'test an instance of CharactersCharacterIdOrdersHistoryGetInner' do
    it 'should create an instance of CharactersCharacterIdOrdersHistoryGetInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ESI::CharactersCharacterIdOrdersHistoryGetInner)
    end
  end
