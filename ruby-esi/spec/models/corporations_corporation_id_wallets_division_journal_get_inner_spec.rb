...
# Unit tests for ESI::CorporationsCorporationIdWalletsDivisionJournalGetInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ESI::CorporationsCorporationIdWalletsDivisionJournalGetInner do
  #let(:instance) { ESI::CorporationsCorporationIdWalletsDivisionJournalGetInner.new }

  describe 'test an instance of CorporationsCorporationIdWalletsDivisionJournalGetInner' do
    it 'should create an instance of CorporationsCorporationIdWalletsDivisionJournalGetInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ESI::CorporationsCorporationIdWalletsDivisionJournalGetInner)
    end
  end
