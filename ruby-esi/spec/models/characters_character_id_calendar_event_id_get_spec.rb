...
# Unit tests for ESI::CharactersCharacterIdCalendarEventIdGet
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ESI::CharactersCharacterIdCalendarEventIdGet do
  #let(:instance) { ESI::CharactersCharacterIdCalendarEventIdGet.new }

  describe 'test an instance of CharactersCharacterIdCalendarEventIdGet' do
    it 'should create an instance of CharactersCharacterIdCalendarEventIdGet' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ESI::CharactersCharacterIdCalendarEventIdGet)
    end
  end
