...
# Unit tests for ESI::CorporationsCorporationIdRolesHistoryGetInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ESI::CorporationsCorporationIdRolesHistoryGetInner do
  #let(:instance) { ESI::CorporationsCorporationIdRolesHistoryGetInner.new }

  describe 'test an instance of CorporationsCorporationIdRolesHistoryGetInner' do
    it 'should create an instance of CorporationsCorporationIdRolesHistoryGetInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ESI::CorporationsCorporationIdRolesHistoryGetInner)
    end
  end
