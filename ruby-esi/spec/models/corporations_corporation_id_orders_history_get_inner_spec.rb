...
# Unit tests for ESI::CorporationsCorporationIdOrdersHistoryGetInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ESI::CorporationsCorporationIdOrdersHistoryGetInner do
  #let(:instance) { ESI::CorporationsCorporationIdOrdersHistoryGetInner.new }

  describe 'test an instance of CorporationsCorporationIdOrdersHistoryGetInner' do
    it 'should create an instance of CorporationsCorporationIdOrdersHistoryGetInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ESI::CorporationsCorporationIdOrdersHistoryGetInner)
    end
  end
