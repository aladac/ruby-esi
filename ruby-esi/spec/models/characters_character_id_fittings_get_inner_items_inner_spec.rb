...
# Unit tests for ESI::CharactersCharacterIdFittingsGetInnerItemsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ESI::CharactersCharacterIdFittingsGetInnerItemsInner do
  #let(:instance) { ESI::CharactersCharacterIdFittingsGetInnerItemsInner.new }

  describe 'test an instance of CharactersCharacterIdFittingsGetInnerItemsInner' do
    it 'should create an instance of CharactersCharacterIdFittingsGetInnerItemsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ESI::CharactersCharacterIdFittingsGetInnerItemsInner)
    end
  end
