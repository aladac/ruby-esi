...
# Unit tests for ESI::UniverseSystemsSystemIdGet
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ESI::UniverseSystemsSystemIdGet do
  #let(:instance) { ESI::UniverseSystemsSystemIdGet.new }

  describe 'test an instance of UniverseSystemsSystemIdGet' do
    it 'should create an instance of UniverseSystemsSystemIdGet' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ESI::UniverseSystemsSystemIdGet)
    end
  end
