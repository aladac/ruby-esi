...
> <Array<InsurancePricesGetInner>> get_insurance_prices(x_compatibility_date, opts)
...
begin
  # List insurance levels
  result = api_instance.get_insurance_prices(x_compatibility_date, opts)
  p result
...
> <Array(<Array<InsurancePricesGetInner>>, Integer, Hash)> get_insurance_prices_with_http_info(x_compatibility_date, opts)

```ruby
begin
  # List insurance levels
  data, status_code, headers = api_instance.get_insurance_prices_with_http_info(x_compatibility_date, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <Array<InsurancePricesGetInner>>
rescue ESI::ApiError => e
...
[**Array&lt;InsurancePricesGetInner&gt;**](InsurancePricesGetInner.md)
