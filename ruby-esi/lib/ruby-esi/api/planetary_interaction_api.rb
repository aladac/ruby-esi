...
module ESI
  class PlanetaryInteractionApi
    ...
    # @option opts [String] :x_tenant The tenant ID for the request. (default to 'tranquility')
    # @option opts [String] :if_modified_since The date the resource was last modified. A 304 will be returned if the resource has not been modified since this date.
    # @return [Array<(Array<CharactersCharacterIdPlanetsGetInner>, Integer, Hash)>] Array<CharactersCharacterIdPlanetsGetInner> data, response status code and response headers
    ...
    # @option opts [String] :x_tenant The tenant ID for the request. (default to 'tranquility')
    # @option opts [String] :if_modified_since The date the resource was last modified. A 304 will be returned if the resource has not been modified since this date.
    # @return [Array<(CharactersCharacterIdPlanetsPlanetIdGet, Integer, Hash)>] CharactersCharacterIdPlanetsPlanetIdGet data, response status code and response headers
    ...
    # @option opts [String] :x_tenant The tenant ID for the request. (default to 'tranquility')
    # @option opts [String] :if_modified_since The date the resource was last modified. A 304 will be returned if the resource has not been modified since this date.
    # @return [Array<(Array<CorporationsCorporationIdCustomsOfficesGetInner>, Integer, Hash)>] Array<CorporationsCorporationIdCustomsOfficesGetInner> data, response status code and response headers
    ...
    # @option opts [String] :x_tenant The tenant ID for the request. (default to 'tranquility')
    # @option opts [String] :if_modified_since The date the resource was last modified. A 304 will be returned if the resource has not been modified since this date.
    # @return [Array<(UniverseSchematicsSchematicIdGet, Integer, Hash)>] UniverseSchematicsSchematicIdGet data, response status code and response headers
