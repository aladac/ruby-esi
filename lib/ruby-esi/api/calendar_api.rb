...
module ESI
  class CalendarApi
    ...
    def get_characters_character_id_calendar_with_http_info(character_id, opts = {})
      ...
      return_type = opts[:return_type] || 'Array<GetCharactersCharacterIdCalendar200Ok>' 
    ...
    def get_characters_character_id_calendar_event_id_with_http_info(character_id, event_id, opts = {})
      ...
      return_type = opts[:return_type] || 'GetCharactersCharacterIdCalendarEventIdOk' 
    ...
    def get_characters_character_id_calendar_event_id_attendees_with_http_info(character_id, event_id, opts = {})
      ...
      return_type = opts[:return_type] || 'Array<GetCharactersCharacterIdCalendarEventIdAttendees200Ok>' 
    ...
    # @option opts [String] :token Access token to use if unable to set a header
    # @return [nil]
    def put_characters_character_id_calendar_event_id(body, character_id, event_id, opts = {})
      put_characters_character_id_calendar_event_id_with_http_info(body, character_id, event_id, opts)
      nil
    end
    ...
    def put_characters_character_id_calendar_event_id_with_http_info(body, character_id, event_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CalendarApi.put_characters_character_id_calendar_event_id ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling CalendarApi.put_characters_character_id_calendar_event_id"
      end
      # verify the required parameter 'character_id' is set
      if @api_client.config.client_side_validation && character_id.nil?
