...
module ESI
  class CharacterApi
    ...
    def get_characters_character_id_with_http_info(character_id, opts = {})
      ...
      return_type = opts[:return_type] || 'GetCharactersCharacterIdOk' 
    ...
    def get_characters_character_id_agents_research_with_http_info(character_id, opts = {})
      ...
      return_type = opts[:return_type] || 'Array<GetCharactersCharacterIdAgentsResearch200Ok>' 
    ...
    def get_characters_character_id_blueprints_with_http_info(character_id, opts = {})
      ...
      return_type = opts[:return_type] || 'Array<GetCharactersCharacterIdBlueprints200Ok>' 
    ...
    def get_characters_character_id_corporationhistory_with_http_info(character_id, opts = {})
      ...
      return_type = opts[:return_type] || 'Array<GetCharactersCharacterIdCorporationhistory200Ok>' 
    ...
    def get_characters_character_id_fatigue_with_http_info(character_id, opts = {})
      ...
      return_type = opts[:return_type] || 'GetCharactersCharacterIdFatigueOk' 
    ...
    def get_characters_character_id_medals_with_http_info(character_id, opts = {})
      ...
      return_type = opts[:return_type] || 'Array<GetCharactersCharacterIdMedals200Ok>' 
    ...
    def get_characters_character_id_notifications_with_http_info(character_id, opts = {})
      ...
      return_type = opts[:return_type] || 'Array<GetCharactersCharacterIdNotifications200Ok>' 
    ...
    def get_characters_character_id_notifications_contacts_with_http_info(character_id, opts = {})
      ...
      return_type = opts[:return_type] || 'Array<GetCharactersCharacterIdNotificationsContacts200Ok>' 
    ...
    def get_characters_character_id_portrait_with_http_info(character_id, opts = {})
      ...
      return_type = opts[:return_type] || 'GetCharactersCharacterIdPortraitOk' 
    ...
    def get_characters_character_id_roles_with_http_info(character_id, opts = {})
      ...
      return_type = opts[:return_type] || 'GetCharactersCharacterIdRolesOk' 
    ...
    def get_characters_character_id_standings_with_http_info(character_id, opts = {})
      ...
      return_type = opts[:return_type] || 'Array<GetCharactersCharacterIdStandings200Ok>' 
    ...
    def get_characters_character_id_titles_with_http_info(character_id, opts = {})
      ...
      return_type = opts[:return_type] || 'Array<GetCharactersCharacterIdTitles200Ok>' 
    ...
    def post_characters_affiliation(body, opts = {})
      data, _status_code, _headers = post_characters_affiliation_with_http_info(body, opts)
      data
    end
    ...
    def post_characters_affiliation_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CharacterApi.post_characters_affiliation ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling CharacterApi.post_characters_affiliation"
      end
      if @api_client.config.client_side_validation && opts[:'datasource'] && !['tranquility'].include?(opts[:'datasource'])
        fail ArgumentError, 'invalid value for "datasource", must be one of tranquility'
      end
      ...
      return_type = opts[:return_type] || 'Array<PostCharactersAffiliation200Ok>' 
    ...
    # @option opts [String] :token Access token to use if unable to set a header
    # @return [Float]
    def post_characters_character_id_cspa(body, character_id, opts = {})
      data, _status_code, _headers = post_characters_character_id_cspa_with_http_info(body, character_id, opts)
      data
    end
    ...
    def post_characters_character_id_cspa_with_http_info(body, character_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CharacterApi.post_characters_character_id_cspa ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling CharacterApi.post_characters_character_id_cspa"
      end
      # verify the required parameter 'character_id' is set
      if @api_client.config.client_side_validation && character_id.nil?
