...
module ESI
  class LoyaltyApi
    ...
    def get_characters_character_id_loyalty_points_with_http_info(character_id, opts = {})
      ...
      return_type = opts[:return_type] || 'Array<GetCharactersCharacterIdLoyaltyPoints200Ok>' 
    ...
    def get_loyalty_stores_corporation_id_offers_with_http_info(corporation_id, opts = {})
      ...
      return_type = opts[:return_type] || 'Array<GetLoyaltyStoresCorporationIdOffers200Ok>' 
