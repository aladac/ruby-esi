...
module ESI
  class SkillsApi
    ...
    def get_characters_character_id_attributes_with_http_info(character_id, opts = {})
      ...
      return_type = opts[:return_type] || 'GetCharactersCharacterIdAttributesOk' 
    ...
    def get_characters_character_id_skillqueue_with_http_info(character_id, opts = {})
      ...
      return_type = opts[:return_type] || 'Array<GetCharactersCharacterIdSkillqueue200Ok>' 
    ...
    def get_characters_character_id_skills_with_http_info(character_id, opts = {})
      ...
      return_type = opts[:return_type] || 'GetCharactersCharacterIdSkillsOk' 
