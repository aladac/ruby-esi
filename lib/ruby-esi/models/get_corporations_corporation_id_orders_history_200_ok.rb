  ...
  class GetCorporationsCorporationIdOrdersHistory200Ok
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ESI::GetCorporationsCorporationIdOrdersHistory200Ok` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ESI::GetCorporationsCorporationIdOrdersHistory200Ok`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      range_validator = EnumAttributeValidator.new('Object', ['1', '10', '2', '20', '3', '30', '4', '40', '5', 'region', 'solarsystem', 'station'])
      return false unless range_validator.valid?(@range)
      return false if @region_id.nil?
      return false if @state.nil?
      state_validator = EnumAttributeValidator.new('Object', ['cancelled', 'expired'])
    ...
    def range=(range)
      validator = EnumAttributeValidator.new('Object', ['1', '10', '2', '20', '3', '30', '4', '40', '5', 'region', 'solarsystem', 'station'])
    ...
    def state=(state)
      validator = EnumAttributeValidator.new('Object', ['cancelled', 'expired'])
