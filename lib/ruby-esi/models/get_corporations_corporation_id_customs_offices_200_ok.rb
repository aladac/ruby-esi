...
module ESI
  ...
  class GetCorporationsCorporationIdCustomsOffices200Ok
    ...
    def self.openapi_types
      {
        :'alliance_tax_rate' => :'Object',
        :'allow_access_with_standings' => :'Object',
        :'allow_alliance_access' => :'Object',
        :'bad_standing_tax_rate' => :'Object',
        :'corporation_tax_rate' => :'Object',
        :'excellent_standing_tax_rate' => :'Object',
        :'good_standing_tax_rate' => :'Object',
        :'neutral_standing_tax_rate' => :'Object',
        :'office_id' => :'Object',
        :'reinforce_exit_end' => :'Object',
        :'reinforce_exit_start' => :'Object',
        :'standing_level' => :'Object',
        :'system_id' => :'Object',
        :'terrible_standing_tax_rate' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ESI::GetCorporationsCorporationIdCustomsOffices200Ok` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ESI::GetCorporationsCorporationIdCustomsOffices200Ok`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      standing_level_validator = EnumAttributeValidator.new('Object', ['bad', 'excellent', 'good', 'neutral', 'terrible'])
    ...
    def standing_level=(standing_level)
      validator = EnumAttributeValidator.new('Object', ['bad', 'excellent', 'good', 'neutral', 'terrible'])
