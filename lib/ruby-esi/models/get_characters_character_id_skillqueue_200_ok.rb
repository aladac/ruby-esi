...
module ESI
  ...
  class GetCharactersCharacterIdSkillqueue200Ok
    ...
    def self.openapi_types
      {
        :'finish_date' => :'Object',
        :'finished_level' => :'Object',
        :'level_end_sp' => :'Object',
        :'level_start_sp' => :'Object',
        :'queue_position' => :'Object',
        :'skill_id' => :'Object',
        :'start_date' => :'Object',
        :'training_start_sp' => :'Object'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `ESI::GetCharactersCharacterIdSkillqueue200Ok` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `ESI::GetCharactersCharacterIdSkillqueue200Ok`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
