...
# Unit tests for ESI::GetUniverseStargatesStargateIdDestination
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetUniverseStargatesStargateIdDestination' do
  before do
    # run before each test
    @instance = ESI::GetUniverseStargatesStargateIdDestination.new
  end
  ...
  describe 'test an instance of GetUniverseStargatesStargateIdDestination' do
    it 'should create an instance of GetUniverseStargatesStargateIdDestination' do
      expect(@instance).to be_instance_of(ESI::GetUniverseStargatesStargateIdDestination)
    end
  end
