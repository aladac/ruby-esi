...
# Unit tests for ESI::DeleteFleetsFleetIdWingsWingIdNotFound
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'DeleteFleetsFleetIdWingsWingIdNotFound' do
  before do
    # run before each test
    @instance = ESI::DeleteFleetsFleetIdWingsWingIdNotFound.new
  end
  ...
  describe 'test an instance of DeleteFleetsFleetIdWingsWingIdNotFound' do
    it 'should create an instance of DeleteFleetsFleetIdWingsWingIdNotFound' do
      expect(@instance).to be_instance_of(ESI::DeleteFleetsFleetIdWingsWingIdNotFound)
    end
  end
