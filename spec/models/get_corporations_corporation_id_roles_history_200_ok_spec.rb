...
# Unit tests for ESI::GetCorporationsCorporationIdRolesHistory200Ok
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCorporationsCorporationIdRolesHistory200Ok' do
  before do
    # run before each test
    @instance = ESI::GetCorporationsCorporationIdRolesHistory200Ok.new
  end
  ...
  describe 'test an instance of GetCorporationsCorporationIdRolesHistory200Ok' do
    it 'should create an instance of GetCorporationsCorporationIdRolesHistory200Ok' do
      expect(@instance).to be_instance_of(ESI::GetCorporationsCorporationIdRolesHistory200Ok)
    end
  end
