...
# Unit tests for ESI::GetCorporationsCorporationIdOrders200Ok
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCorporationsCorporationIdOrders200Ok' do
  before do
    # run before each test
    @instance = ESI::GetCorporationsCorporationIdOrders200Ok.new
  end
  ...
  describe 'test an instance of GetCorporationsCorporationIdOrders200Ok' do
    it 'should create an instance of GetCorporationsCorporationIdOrders200Ok' do
      expect(@instance).to be_instance_of(ESI::GetCorporationsCorporationIdOrders200Ok)
    end
  end
