...
# Unit tests for ESI::GetCharactersCharacterIdStandings200Ok
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCharactersCharacterIdStandings200Ok' do
  before do
    # run before each test
    @instance = ESI::GetCharactersCharacterIdStandings200Ok.new
  end
  ...
  describe 'test an instance of GetCharactersCharacterIdStandings200Ok' do
    it 'should create an instance of GetCharactersCharacterIdStandings200Ok' do
      expect(@instance).to be_instance_of(ESI::GetCharactersCharacterIdStandings200Ok)
    end
  end
