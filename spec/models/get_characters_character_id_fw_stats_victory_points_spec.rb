...
# Unit tests for ESI::GetCharactersCharacterIdFwStatsVictoryPoints
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCharactersCharacterIdFwStatsVictoryPoints' do
  before do
    # run before each test
    @instance = ESI::GetCharactersCharacterIdFwStatsVictoryPoints.new
  end
  ...
  describe 'test an instance of GetCharactersCharacterIdFwStatsVictoryPoints' do
    it 'should create an instance of GetCharactersCharacterIdFwStatsVictoryPoints' do
      expect(@instance).to be_instance_of(ESI::GetCharactersCharacterIdFwStatsVictoryPoints)
    end
  end
