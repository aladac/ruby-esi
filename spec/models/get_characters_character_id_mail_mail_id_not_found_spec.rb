...
# Unit tests for ESI::GetCharactersCharacterIdMailMailIdNotFound
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCharactersCharacterIdMailMailIdNotFound' do
  before do
    # run before each test
    @instance = ESI::GetCharactersCharacterIdMailMailIdNotFound.new
  end
  ...
  describe 'test an instance of GetCharactersCharacterIdMailMailIdNotFound' do
    it 'should create an instance of GetCharactersCharacterIdMailMailIdNotFound' do
      expect(@instance).to be_instance_of(ESI::GetCharactersCharacterIdMailMailIdNotFound)
    end
  end
