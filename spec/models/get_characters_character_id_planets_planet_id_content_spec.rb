...
# Unit tests for ESI::GetCharactersCharacterIdPlanetsPlanetIdContent
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCharactersCharacterIdPlanetsPlanetIdContent' do
  before do
    # run before each test
    @instance = ESI::GetCharactersCharacterIdPlanetsPlanetIdContent.new
  end
  ...
  describe 'test an instance of GetCharactersCharacterIdPlanetsPlanetIdContent' do
    it 'should create an instance of GetCharactersCharacterIdPlanetsPlanetIdContent' do
      expect(@instance).to be_instance_of(ESI::GetCharactersCharacterIdPlanetsPlanetIdContent)
    end
  end
