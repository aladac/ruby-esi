...
# Unit tests for ESI::GetWarsWarIdUnprocessableEntity
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetWarsWarIdUnprocessableEntity' do
  before do
    # run before each test
    @instance = ESI::GetWarsWarIdUnprocessableEntity.new
  end
  ...
  describe 'test an instance of GetWarsWarIdUnprocessableEntity' do
    it 'should create an instance of GetWarsWarIdUnprocessableEntity' do
      expect(@instance).to be_instance_of(ESI::GetWarsWarIdUnprocessableEntity)
    end
  end
