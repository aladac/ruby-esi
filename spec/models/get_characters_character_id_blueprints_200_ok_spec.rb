...
# Unit tests for ESI::GetCharactersCharacterIdBlueprints200Ok
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCharactersCharacterIdBlueprints200Ok' do
  before do
    # run before each test
    @instance = ESI::GetCharactersCharacterIdBlueprints200Ok.new
  end
  ...
  describe 'test an instance of GetCharactersCharacterIdBlueprints200Ok' do
    it 'should create an instance of GetCharactersCharacterIdBlueprints200Ok' do
      expect(@instance).to be_instance_of(ESI::GetCharactersCharacterIdBlueprints200Ok)
    end
  end
