...
# Unit tests for ESI::GetCharactersCharacterIdSkillsSkill
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCharactersCharacterIdSkillsSkill' do
  before do
    # run before each test
    @instance = ESI::GetCharactersCharacterIdSkillsSkill.new
  end
  ...
  describe 'test an instance of GetCharactersCharacterIdSkillsSkill' do
    it 'should create an instance of GetCharactersCharacterIdSkillsSkill' do
      expect(@instance).to be_instance_of(ESI::GetCharactersCharacterIdSkillsSkill)
    end
  end
