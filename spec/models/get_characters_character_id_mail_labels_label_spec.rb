...
# Unit tests for ESI::GetCharactersCharacterIdMailLabelsLabel
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCharactersCharacterIdMailLabelsLabel' do
  before do
    # run before each test
    @instance = ESI::GetCharactersCharacterIdMailLabelsLabel.new
  end
  ...
  describe 'test an instance of GetCharactersCharacterIdMailLabelsLabel' do
    it 'should create an instance of GetCharactersCharacterIdMailLabelsLabel' do
      expect(@instance).to be_instance_of(ESI::GetCharactersCharacterIdMailLabelsLabel)
    end
  end
