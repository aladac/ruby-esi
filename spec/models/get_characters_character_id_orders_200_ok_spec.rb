...
# Unit tests for ESI::GetCharactersCharacterIdOrders200Ok
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCharactersCharacterIdOrders200Ok' do
  before do
    # run before each test
    @instance = ESI::GetCharactersCharacterIdOrders200Ok.new
  end
  ...
  describe 'test an instance of GetCharactersCharacterIdOrders200Ok' do
    it 'should create an instance of GetCharactersCharacterIdOrders200Ok' do
      expect(@instance).to be_instance_of(ESI::GetCharactersCharacterIdOrders200Ok)
    end
  end
