...
# Unit tests for ESI::GetCharactersCharacterIdShipOk
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCharactersCharacterIdShipOk' do
  before do
    # run before each test
    @instance = ESI::GetCharactersCharacterIdShipOk.new
  end
  ...
  describe 'test an instance of GetCharactersCharacterIdShipOk' do
    it 'should create an instance of GetCharactersCharacterIdShipOk' do
      expect(@instance).to be_instance_of(ESI::GetCharactersCharacterIdShipOk)
    end
  end
