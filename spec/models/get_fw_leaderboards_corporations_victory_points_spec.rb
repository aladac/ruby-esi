...
# Unit tests for ESI::GetFwLeaderboardsCorporationsVictoryPoints
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetFwLeaderboardsCorporationsVictoryPoints' do
  before do
    # run before each test
    @instance = ESI::GetFwLeaderboardsCorporationsVictoryPoints.new
  end
  ...
  describe 'test an instance of GetFwLeaderboardsCorporationsVictoryPoints' do
    it 'should create an instance of GetFwLeaderboardsCorporationsVictoryPoints' do
      expect(@instance).to be_instance_of(ESI::GetFwLeaderboardsCorporationsVictoryPoints)
    end
  end
