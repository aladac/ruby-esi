...
# Unit tests for ESI::PostCharactersCharacterIdAssetsNames200Ok
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PostCharactersCharacterIdAssetsNames200Ok' do
  before do
    # run before each test
    @instance = ESI::PostCharactersCharacterIdAssetsNames200Ok.new
  end
  ...
  describe 'test an instance of PostCharactersCharacterIdAssetsNames200Ok' do
    it 'should create an instance of PostCharactersCharacterIdAssetsNames200Ok' do
      expect(@instance).to be_instance_of(ESI::PostCharactersCharacterIdAssetsNames200Ok)
    end
  end
