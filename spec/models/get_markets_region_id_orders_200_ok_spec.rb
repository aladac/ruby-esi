...
# Unit tests for ESI::GetMarketsRegionIdOrders200Ok
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetMarketsRegionIdOrders200Ok' do
  before do
    # run before each test
    @instance = ESI::GetMarketsRegionIdOrders200Ok.new
  end
  ...
  describe 'test an instance of GetMarketsRegionIdOrders200Ok' do
    it 'should create an instance of GetMarketsRegionIdOrders200Ok' do
      expect(@instance).to be_instance_of(ESI::GetMarketsRegionIdOrders200Ok)
    end
  end
