...
# Unit tests for ESI::GetContractsPublicBidsContractIdForbidden
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetContractsPublicBidsContractIdForbidden' do
  before do
    # run before each test
    @instance = ESI::GetContractsPublicBidsContractIdForbidden.new
  end
  ...
  describe 'test an instance of GetContractsPublicBidsContractIdForbidden' do
    it 'should create an instance of GetContractsPublicBidsContractIdForbidden' do
      expect(@instance).to be_instance_of(ESI::GetContractsPublicBidsContractIdForbidden)
    end
  end
