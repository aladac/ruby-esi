...
# Unit tests for ESI::GetCorporationsCorporationIdShareholders200Ok
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCorporationsCorporationIdShareholders200Ok' do
  before do
    # run before each test
    @instance = ESI::GetCorporationsCorporationIdShareholders200Ok.new
  end
  ...
  describe 'test an instance of GetCorporationsCorporationIdShareholders200Ok' do
    it 'should create an instance of GetCorporationsCorporationIdShareholders200Ok' do
      expect(@instance).to be_instance_of(ESI::GetCorporationsCorporationIdShareholders200Ok)
    end
  end
