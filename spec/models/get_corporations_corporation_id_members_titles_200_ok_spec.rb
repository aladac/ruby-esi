...
# Unit tests for ESI::GetCorporationsCorporationIdMembersTitles200Ok
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCorporationsCorporationIdMembersTitles200Ok' do
  before do
    # run before each test
    @instance = ESI::GetCorporationsCorporationIdMembersTitles200Ok.new
  end
  ...
  describe 'test an instance of GetCorporationsCorporationIdMembersTitles200Ok' do
    it 'should create an instance of GetCorporationsCorporationIdMembersTitles200Ok' do
      expect(@instance).to be_instance_of(ESI::GetCorporationsCorporationIdMembersTitles200Ok)
    end
  end
