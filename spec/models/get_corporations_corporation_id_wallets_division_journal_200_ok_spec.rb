...
# Unit tests for ESI::GetCorporationsCorporationIdWalletsDivisionJournal200Ok
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCorporationsCorporationIdWalletsDivisionJournal200Ok' do
  before do
    # run before each test
    @instance = ESI::GetCorporationsCorporationIdWalletsDivisionJournal200Ok.new
  end
  ...
  describe 'test an instance of GetCorporationsCorporationIdWalletsDivisionJournal200Ok' do
    it 'should create an instance of GetCorporationsCorporationIdWalletsDivisionJournal200Ok' do
      expect(@instance).to be_instance_of(ESI::GetCorporationsCorporationIdWalletsDivisionJournal200Ok)
    end
  end
