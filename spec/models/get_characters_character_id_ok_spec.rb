...
# Unit tests for ESI::GetCharactersCharacterIdOk
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCharactersCharacterIdOk' do
  before do
    # run before each test
    @instance = ESI::GetCharactersCharacterIdOk.new
  end
  ...
  describe 'test an instance of GetCharactersCharacterIdOk' do
    it 'should create an instance of GetCharactersCharacterIdOk' do
      expect(@instance).to be_instance_of(ESI::GetCharactersCharacterIdOk)
    end
  end
