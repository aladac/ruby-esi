...
# Unit tests for ESI::PutFleetsFleetIdNewSettings
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PutFleetsFleetIdNewSettings' do
  before do
    # run before each test
    @instance = ESI::PutFleetsFleetIdNewSettings.new
  end
  ...
  describe 'test an instance of PutFleetsFleetIdNewSettings' do
    it 'should create an instance of PutFleetsFleetIdNewSettings' do
      expect(@instance).to be_instance_of(ESI::PutFleetsFleetIdNewSettings)
    end
  end
