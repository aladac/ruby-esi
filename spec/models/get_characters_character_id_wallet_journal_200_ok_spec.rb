...
# Unit tests for ESI::GetCharactersCharacterIdWalletJournal200Ok
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCharactersCharacterIdWalletJournal200Ok' do
  before do
    # run before each test
    @instance = ESI::GetCharactersCharacterIdWalletJournal200Ok.new
  end
  ...
  describe 'test an instance of GetCharactersCharacterIdWalletJournal200Ok' do
    it 'should create an instance of GetCharactersCharacterIdWalletJournal200Ok' do
      expect(@instance).to be_instance_of(ESI::GetCharactersCharacterIdWalletJournal200Ok)
    end
  end
