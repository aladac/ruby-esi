...
# Unit tests for ESI::GetCorporationsCorporationIdAssets200Ok
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCorporationsCorporationIdAssets200Ok' do
  before do
    # run before each test
    @instance = ESI::GetCorporationsCorporationIdAssets200Ok.new
  end
  ...
  describe 'test an instance of GetCorporationsCorporationIdAssets200Ok' do
    it 'should create an instance of GetCorporationsCorporationIdAssets200Ok' do
      expect(@instance).to be_instance_of(ESI::GetCorporationsCorporationIdAssets200Ok)
    end
  end
