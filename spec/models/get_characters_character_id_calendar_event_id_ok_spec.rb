...
# Unit tests for ESI::GetCharactersCharacterIdCalendarEventIdOk
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCharactersCharacterIdCalendarEventIdOk' do
  before do
    # run before each test
    @instance = ESI::GetCharactersCharacterIdCalendarEventIdOk.new
  end
  ...
  describe 'test an instance of GetCharactersCharacterIdCalendarEventIdOk' do
    it 'should create an instance of GetCharactersCharacterIdCalendarEventIdOk' do
      expect(@instance).to be_instance_of(ESI::GetCharactersCharacterIdCalendarEventIdOk)
    end
  end
