...
# Unit tests for ESI::GetUniverseStationsStationIdOk
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetUniverseStationsStationIdOk' do
  before do
    # run before each test
    @instance = ESI::GetUniverseStationsStationIdOk.new
  end
  ...
  describe 'test an instance of GetUniverseStationsStationIdOk' do
    it 'should create an instance of GetUniverseStationsStationIdOk' do
      expect(@instance).to be_instance_of(ESI::GetUniverseStationsStationIdOk)
    end
  end
