...
# Unit tests for ESI::GetCharactersCharacterIdOrdersHistory200Ok
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCharactersCharacterIdOrdersHistory200Ok' do
  before do
    # run before each test
    @instance = ESI::GetCharactersCharacterIdOrdersHistory200Ok.new
  end
  ...
  describe 'test an instance of GetCharactersCharacterIdOrdersHistory200Ok' do
    it 'should create an instance of GetCharactersCharacterIdOrdersHistory200Ok' do
      expect(@instance).to be_instance_of(ESI::GetCharactersCharacterIdOrdersHistory200Ok)
    end
  end
