...
# Unit tests for ESI::GetCorporationsCorporationIdBlueprints200Ok
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCorporationsCorporationIdBlueprints200Ok' do
  before do
    # run before each test
    @instance = ESI::GetCorporationsCorporationIdBlueprints200Ok.new
  end
  ...
  describe 'test an instance of GetCorporationsCorporationIdBlueprints200Ok' do
    it 'should create an instance of GetCorporationsCorporationIdBlueprints200Ok' do
      expect(@instance).to be_instance_of(ESI::GetCorporationsCorporationIdBlueprints200Ok)
    end
  end
