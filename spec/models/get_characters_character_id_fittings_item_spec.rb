...
# Unit tests for ESI::GetCharactersCharacterIdFittingsItem
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCharactersCharacterIdFittingsItem' do
  before do
    # run before each test
    @instance = ESI::GetCharactersCharacterIdFittingsItem.new
  end
  ...
  describe 'test an instance of GetCharactersCharacterIdFittingsItem' do
    it 'should create an instance of GetCharactersCharacterIdFittingsItem' do
      expect(@instance).to be_instance_of(ESI::GetCharactersCharacterIdFittingsItem)
    end
  end
