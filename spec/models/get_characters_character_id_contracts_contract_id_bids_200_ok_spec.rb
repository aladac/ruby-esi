...
# Unit tests for ESI::GetCharactersCharacterIdContractsContractIdBids200Ok
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCharactersCharacterIdContractsContractIdBids200Ok' do
  before do
    # run before each test
    @instance = ESI::GetCharactersCharacterIdContractsContractIdBids200Ok.new
  end
  ...
  describe 'test an instance of GetCharactersCharacterIdContractsContractIdBids200Ok' do
    it 'should create an instance of GetCharactersCharacterIdContractsContractIdBids200Ok' do
      expect(@instance).to be_instance_of(ESI::GetCharactersCharacterIdContractsContractIdBids200Ok)
    end
  end
