...
# Unit tests for ESI::GetCharactersCharacterIdLoyaltyPoints200Ok
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCharactersCharacterIdLoyaltyPoints200Ok' do
  before do
    # run before each test
    @instance = ESI::GetCharactersCharacterIdLoyaltyPoints200Ok.new
  end
  ...
  describe 'test an instance of GetCharactersCharacterIdLoyaltyPoints200Ok' do
    it 'should create an instance of GetCharactersCharacterIdLoyaltyPoints200Ok' do
      expect(@instance).to be_instance_of(ESI::GetCharactersCharacterIdLoyaltyPoints200Ok)
    end
  end
