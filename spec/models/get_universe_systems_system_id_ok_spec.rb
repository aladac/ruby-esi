...
# Unit tests for ESI::GetUniverseSystemsSystemIdOk
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetUniverseSystemsSystemIdOk' do
  before do
    # run before each test
    @instance = ESI::GetUniverseSystemsSystemIdOk.new
  end
  ...
  describe 'test an instance of GetUniverseSystemsSystemIdOk' do
    it 'should create an instance of GetUniverseSystemsSystemIdOk' do
      expect(@instance).to be_instance_of(ESI::GetUniverseSystemsSystemIdOk)
    end
  end
