...
# Unit tests for ESI::GetFwLeaderboardsYesterdayYesterday1
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetFwLeaderboardsYesterdayYesterday1' do
  before do
    # run before each test
    @instance = ESI::GetFwLeaderboardsYesterdayYesterday1.new
  end
  ...
  describe 'test an instance of GetFwLeaderboardsYesterdayYesterday1' do
    it 'should create an instance of GetFwLeaderboardsYesterdayYesterday1' do
      expect(@instance).to be_instance_of(ESI::GetFwLeaderboardsYesterdayYesterday1)
    end
  end
