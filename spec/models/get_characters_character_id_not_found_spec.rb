...
# Unit tests for ESI::GetCharactersCharacterIdNotFound
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCharactersCharacterIdNotFound' do
  before do
    # run before each test
    @instance = ESI::GetCharactersCharacterIdNotFound.new
  end
  ...
  describe 'test an instance of GetCharactersCharacterIdNotFound' do
    it 'should create an instance of GetCharactersCharacterIdNotFound' do
      expect(@instance).to be_instance_of(ESI::GetCharactersCharacterIdNotFound)
    end
  end
