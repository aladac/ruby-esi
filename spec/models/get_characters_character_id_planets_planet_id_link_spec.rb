...
# Unit tests for ESI::GetCharactersCharacterIdPlanetsPlanetIdLink
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCharactersCharacterIdPlanetsPlanetIdLink' do
  before do
    # run before each test
    @instance = ESI::GetCharactersCharacterIdPlanetsPlanetIdLink.new
  end
  ...
  describe 'test an instance of GetCharactersCharacterIdPlanetsPlanetIdLink' do
    it 'should create an instance of GetCharactersCharacterIdPlanetsPlanetIdLink' do
      expect(@instance).to be_instance_of(ESI::GetCharactersCharacterIdPlanetsPlanetIdLink)
    end
  end
