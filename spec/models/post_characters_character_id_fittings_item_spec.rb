...
# Unit tests for ESI::PostCharactersCharacterIdFittingsItem
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PostCharactersCharacterIdFittingsItem' do
  before do
    # run before each test
    @instance = ESI::PostCharactersCharacterIdFittingsItem.new
  end
  ...
  describe 'test an instance of PostCharactersCharacterIdFittingsItem' do
    it 'should create an instance of PostCharactersCharacterIdFittingsItem' do
      expect(@instance).to be_instance_of(ESI::PostCharactersCharacterIdFittingsItem)
    end
  end
