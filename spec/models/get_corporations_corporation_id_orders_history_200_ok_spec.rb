...
# Unit tests for ESI::GetCorporationsCorporationIdOrdersHistory200Ok
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCorporationsCorporationIdOrdersHistory200Ok' do
  before do
    # run before each test
    @instance = ESI::GetCorporationsCorporationIdOrdersHistory200Ok.new
  end
  ...
  describe 'test an instance of GetCorporationsCorporationIdOrdersHistory200Ok' do
    it 'should create an instance of GetCorporationsCorporationIdOrdersHistory200Ok' do
      expect(@instance).to be_instance_of(ESI::GetCorporationsCorporationIdOrdersHistory200Ok)
    end
  end
