...
# Unit tests for ESI::GetCorporationsCorporationIdStarbasesStarbaseIdOk
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCorporationsCorporationIdStarbasesStarbaseIdOk' do
  before do
    # run before each test
    @instance = ESI::GetCorporationsCorporationIdStarbasesStarbaseIdOk.new
  end
  ...
  describe 'test an instance of GetCorporationsCorporationIdStarbasesStarbaseIdOk' do
    it 'should create an instance of GetCorporationsCorporationIdStarbasesStarbaseIdOk' do
      expect(@instance).to be_instance_of(ESI::GetCorporationsCorporationIdStarbasesStarbaseIdOk)
    end
  end
