...
# Unit tests for ESI::GetUniverseSystemsSystemIdPosition
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetUniverseSystemsSystemIdPosition' do
  before do
    # run before each test
    @instance = ESI::GetUniverseSystemsSystemIdPosition.new
  end
  ...
  describe 'test an instance of GetUniverseSystemsSystemIdPosition' do
    it 'should create an instance of GetUniverseSystemsSystemIdPosition' do
      expect(@instance).to be_instance_of(ESI::GetUniverseSystemsSystemIdPosition)
    end
  end
