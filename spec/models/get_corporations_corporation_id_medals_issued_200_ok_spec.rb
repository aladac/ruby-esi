...
# Unit tests for ESI::GetCorporationsCorporationIdMedalsIssued200Ok
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCorporationsCorporationIdMedalsIssued200Ok' do
  before do
    # run before each test
    @instance = ESI::GetCorporationsCorporationIdMedalsIssued200Ok.new
  end
  ...
  describe 'test an instance of GetCorporationsCorporationIdMedalsIssued200Ok' do
    it 'should create an instance of GetCorporationsCorporationIdMedalsIssued200Ok' do
      expect(@instance).to be_instance_of(ESI::GetCorporationsCorporationIdMedalsIssued200Ok)
    end
  end
