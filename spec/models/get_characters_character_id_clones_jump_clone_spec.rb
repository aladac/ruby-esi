...
# Unit tests for ESI::GetCharactersCharacterIdClonesJumpClone
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCharactersCharacterIdClonesJumpClone' do
  before do
    # run before each test
    @instance = ESI::GetCharactersCharacterIdClonesJumpClone.new
  end
  ...
  describe 'test an instance of GetCharactersCharacterIdClonesJumpClone' do
    it 'should create an instance of GetCharactersCharacterIdClonesJumpClone' do
      expect(@instance).to be_instance_of(ESI::GetCharactersCharacterIdClonesJumpClone)
    end
  end
