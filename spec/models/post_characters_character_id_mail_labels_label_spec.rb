...
# Unit tests for ESI::PostCharactersCharacterIdMailLabelsLabel
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'PostCharactersCharacterIdMailLabelsLabel' do
  before do
    # run before each test
    @instance = ESI::PostCharactersCharacterIdMailLabelsLabel.new
  end
  ...
  describe 'test an instance of PostCharactersCharacterIdMailLabelsLabel' do
    it 'should create an instance of PostCharactersCharacterIdMailLabelsLabel' do
      expect(@instance).to be_instance_of(ESI::PostCharactersCharacterIdMailLabelsLabel)
    end
  end
