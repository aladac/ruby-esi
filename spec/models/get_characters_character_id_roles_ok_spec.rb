...
# Unit tests for ESI::GetCharactersCharacterIdRolesOk
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCharactersCharacterIdRolesOk' do
  before do
    # run before each test
    @instance = ESI::GetCharactersCharacterIdRolesOk.new
  end
  ...
  describe 'test an instance of GetCharactersCharacterIdRolesOk' do
    it 'should create an instance of GetCharactersCharacterIdRolesOk' do
      expect(@instance).to be_instance_of(ESI::GetCharactersCharacterIdRolesOk)
    end
  end
