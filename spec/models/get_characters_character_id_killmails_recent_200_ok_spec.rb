...
# Unit tests for ESI::GetCharactersCharacterIdKillmailsRecent200Ok
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCharactersCharacterIdKillmailsRecent200Ok' do
  before do
    # run before each test
    @instance = ESI::GetCharactersCharacterIdKillmailsRecent200Ok.new
  end
  ...
  describe 'test an instance of GetCharactersCharacterIdKillmailsRecent200Ok' do
    it 'should create an instance of GetCharactersCharacterIdKillmailsRecent200Ok' do
      expect(@instance).to be_instance_of(ESI::GetCharactersCharacterIdKillmailsRecent200Ok)
    end
  end
