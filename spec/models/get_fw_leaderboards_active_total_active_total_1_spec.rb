...
# Unit tests for ESI::GetFwLeaderboardsActiveTotalActiveTotal1
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetFwLeaderboardsActiveTotalActiveTotal1' do
  before do
    # run before each test
    @instance = ESI::GetFwLeaderboardsActiveTotalActiveTotal1.new
  end
  ...
  describe 'test an instance of GetFwLeaderboardsActiveTotalActiveTotal1' do
    it 'should create an instance of GetFwLeaderboardsActiveTotalActiveTotal1' do
      expect(@instance).to be_instance_of(ESI::GetFwLeaderboardsActiveTotalActiveTotal1)
    end
  end
