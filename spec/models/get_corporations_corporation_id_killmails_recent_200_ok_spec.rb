...
# Unit tests for ESI::GetCorporationsCorporationIdKillmailsRecent200Ok
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCorporationsCorporationIdKillmailsRecent200Ok' do
  before do
    # run before each test
    @instance = ESI::GetCorporationsCorporationIdKillmailsRecent200Ok.new
  end
  ...
  describe 'test an instance of GetCorporationsCorporationIdKillmailsRecent200Ok' do
    it 'should create an instance of GetCorporationsCorporationIdKillmailsRecent200Ok' do
      expect(@instance).to be_instance_of(ESI::GetCorporationsCorporationIdKillmailsRecent200Ok)
    end
  end
