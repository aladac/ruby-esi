...
# Unit tests for ESI::GetCharactersCharacterIdContacts200Ok
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCharactersCharacterIdContacts200Ok' do
  before do
    # run before each test
    @instance = ESI::GetCharactersCharacterIdContacts200Ok.new
  end
  ...
  describe 'test an instance of GetCharactersCharacterIdContacts200Ok' do
    it 'should create an instance of GetCharactersCharacterIdContacts200Ok' do
      expect(@instance).to be_instance_of(ESI::GetCharactersCharacterIdContacts200Ok)
    end
  end
