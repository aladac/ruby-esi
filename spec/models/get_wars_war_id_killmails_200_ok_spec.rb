...
# Unit tests for ESI::GetWarsWarIdKillmails200Ok
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetWarsWarIdKillmails200Ok' do
  before do
    # run before each test
    @instance = ESI::GetWarsWarIdKillmails200Ok.new
  end
  ...
  describe 'test an instance of GetWarsWarIdKillmails200Ok' do
    it 'should create an instance of GetWarsWarIdKillmails200Ok' do
      expect(@instance).to be_instance_of(ESI::GetWarsWarIdKillmails200Ok)
    end
  end
