...
# Unit tests for ESI::GetCharactersCharacterIdFleetOk
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetCharactersCharacterIdFleetOk' do
  before do
    # run before each test
    @instance = ESI::GetCharactersCharacterIdFleetOk.new
  end
  ...
  describe 'test an instance of GetCharactersCharacterIdFleetOk' do
    it 'should create an instance of GetCharactersCharacterIdFleetOk' do
      expect(@instance).to be_instance_of(ESI::GetCharactersCharacterIdFleetOk)
    end
  end
