...
# Unit tests for ESI::GetFwLeaderboardsCorporationsOk
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetFwLeaderboardsCorporationsOk' do
  before do
    # run before each test
    @instance = ESI::GetFwLeaderboardsCorporationsOk.new
  end
  ...
  describe 'test an instance of GetFwLeaderboardsCorporationsOk' do
    it 'should create an instance of GetFwLeaderboardsCorporationsOk' do
      expect(@instance).to be_instance_of(ESI::GetFwLeaderboardsCorporationsOk)
    end
  end
