...
# Unit tests for ESI::GetSovereigntyCampaignsParticipant
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GetSovereigntyCampaignsParticipant' do
  before do
    # run before each test
    @instance = ESI::GetSovereigntyCampaignsParticipant.new
  end
  ...
  describe 'test an instance of GetSovereigntyCampaignsParticipant' do
    it 'should create an instance of GetSovereigntyCampaignsParticipant' do
      expect(@instance).to be_instance_of(ESI::GetSovereigntyCampaignsParticipant)
    end
  end
