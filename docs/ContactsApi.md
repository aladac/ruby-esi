...
> Array&lt;Integer&gt; post_characters_character_id_contacts(bodystandingcharacter_id, opts)
...
begin
  #Add contacts
  result = api_instance.post_characters_character_id_contacts(bodystandingcharacter_id, opts)
  p result
rescue ESI::ApiError => e
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**Array&lt;Integer&gt;**](Integer.md)| A list of contacts | 
...
> put_characters_character_id_contacts(bodystandingcharacter_id, opts)
...
begin
  #Edit contacts
  api_instance.put_characters_character_id_contacts(bodystandingcharacter_id, opts)
rescue ESI::ApiError => e
