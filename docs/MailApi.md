...
> Integer post_characters_character_id_mail(bodycharacter_id, opts)
...
begin
  #Send a new mail
  result = api_instance.post_characters_character_id_mail(bodycharacter_id, opts)
  p result
rescue ESI::ApiError => e
...
> Integer post_characters_character_id_mail_labels(bodycharacter_id, opts)
...
begin
  #Create a mail label
  result = api_instance.post_characters_character_id_mail_labels(bodycharacter_id, opts)
  p result
rescue ESI::ApiError => e
...
> put_characters_character_id_mail_mail_id(bodycharacter_idmail_id, opts)
...
begin
  #Update metadata about a mail
  api_instance.put_characters_character_id_mail_mail_id(bodycharacter_idmail_id, opts)
rescue ESI::ApiError => e
